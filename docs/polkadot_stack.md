...
| NFT | [ternoa](https://github.com/capsule-corp-ternoa/chain) :green_circle:, [FRAME Pallet: NFTs for Substrate](https://github.com/danforbes/pallet-nft) :red_circle:, [Unique NFT Parachain](https://github.com/UniqueNetwork/unique-chain) :yellow_circle:, [DNFT](https://github.com/DNFT-Team/dnft-substrate-node/tree/master/pallets) :red_circle:, [RMRK-Substrate](https://github.com/rmrk-team/rmrk-substrate) :green_circle:
